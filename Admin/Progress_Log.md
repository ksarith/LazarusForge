...
1. **GMP-010 closed 2026-08-30** — the recommended first pick closed the same day it was promoted. Lane A now has 6 remaining confirmed candidates across the two clusters (GMP-006/011/012; GI-004/GI-006/GU-002), plus the 2 split spec/Automation items. See Lane A section above and Current Lessons for the full Closure Event account.
