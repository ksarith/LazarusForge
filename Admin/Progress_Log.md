...
**Second finding, while adding this entry:** the 2026-08-25 Charter-audit entry below had been appended after the file's stated "most recent first" order, landing last instead of first — the same category of self-referential ordering slip caught twice already this week in this exact file (lost entries 2026-08-24, EC-batch header loss 2026-08-22/found-08-24). Reordered here. Given three separate instances of this file failing to maintain its own stated invariants (content loss, missing rotation, now ordering) inside one week, the standing fix from 2026-08-24 — verify a file's own claims against its actual content after any edit — is being treated as applying to *this file itself* every time it's touched, not only to Unknowns.md-style closures.
