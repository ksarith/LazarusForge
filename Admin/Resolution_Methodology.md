...
| 2026-08-28 | Patterns 6–9 registration | Distilled specification/operational-clearance split, discharge-vs-specification, verify-closure-format-against-precedent, and self-maintenance verification from the 2026-08-23 through 2026-08-27 session's closures and hygiene fixes | Four real, repeatable patterns had been independently rediscovered each time rather than cited, because they were never captured here | Recording a pattern once is cheaper than rediscovering it every session; this entry itself closes that gap for Patterns 6–9 | Analogous | After a case that exercises Pattern 6, 7, 8, or 9 against a new domain |
