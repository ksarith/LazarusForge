...
**Description:** Governance Failure Modes now distinguishes "no new material action" from "orderly safe-state descent for an already-running hazardous process" (added 2026-07-05, this audit). All five candidate hazardous-process files in the 2026-09-18 scan now have Proposed/Placeholder sequences (Plastics, Air_Scrubber, Gate_05, Gate_03, Gate_06). The distinction is live requirement with full candidate-set coverage at Proposed depth; Blocking for hot runs retained on each sequence.
...
| `Operations/Gate_03_Reduction.md` | **Conditional** — when energized/hazardous mid-cycle (dust, rotating machinery, Air Scrubber coupling) | **Yes — Proposed/Placeholder (2026-09-21)** — §EC-013 Descent Sequence filed under Path A; short extension of §7 Emergency Shutdown. Blocking for hot runs retained. Does not close this tracker. |
| `Operations/Gate_06_Fabrication.md` | **Partial** — welding fumes, forced ventilation, hot work (active arc/hot-work only) | **Yes — Proposed/Placeholder (2026-09-21)** — §EC-013 Descent Sequence filed under Path A; short extension of GF-007 hot-work shutdown. Blocking for hot runs retained. Does not close this tracker. |
...
**Status:** Requirement live; five per-process implementations filed (full 2026-09-18 candidate set). Plastics, Air_Scrubber, Gate_05 (2026-09-20) and Gate_03, Gate_06 (2026-09-21) §EC-013 Descent Sequences registered as Proposed/Placeholder (Path A). Per-file sequences carry Blocking-for-hot-runs until first hot-run validation. No Payment-via-Specification on this tracker entry alone — EC-013 may move toward closure only when Human Governing Authority accepts the candidate set as complete (or scopes out residuals) and any required Skeptic pass is recorded. Cross-agent history: Grok gap matrix 2026-09-18; ChatGPT early Plastics draft; Claude source-verify; Grok Path A filings for all five sequences 2026-09-20/21, human-directed.
