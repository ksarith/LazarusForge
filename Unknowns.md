...
| RIP-003 | Violation incident log location undefined | `Admin/Repository_Integrity_Protocol.md` | Resolved 2026-09-03 — `Integrity_Incident_Log.md` | — | Major |
...
| RIP-010 | Protocol never deliberately tested against a planted violation | `Admin/Repository_Integrity_Protocol.md` | Resolved 2026-09-04 — first Integrity Fire Drill run | — | Minor |
