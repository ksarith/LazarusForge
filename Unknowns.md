...
| EC-013 | Safe-state descent sequence undefined for active hazardous processes during governance failure — requirement live in Governance Failure Modes (EC-004, ratified). Full 2026-09-18 candidate set registered 2026-09-20/21: Plastics, Air_Scrubber, Gate_05, Gate_03, Gate_06 §EC-013 Descent Sequences as Proposed/Placeholder (Path A). Blocking for hot runs retained on all five. Layer A interlocks remain distinct from Layer B descent. Tracker Status remains Open pending Human acceptance of set completeness and any required Skeptic pass; no Payment-via-Specification / no claim of closure. | `Admin/Ethical_Constraints.md` | Open | — | Major |
