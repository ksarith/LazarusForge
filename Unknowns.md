...
**Version 5.49 — 2026-09-20. EC-013 Gate_05 descent sequence filed as Proposed/Placeholder (Path A).** Third per-process implementation registered: `Operations/Gate_05_Separation_Thermal.md` §EC-013 Descent Sequence (stop-spin-before-cool; hot-idle preference). Plastics and Air_Scrubber sequences already filed same day. Tracker Status remains Open (Gate_03 / Gate_06 still lack sequences). Blocking for hot runs retained. No claim of EC-013 closure. Cross-agent: Grok filed under explicit Path A direction.**
...
| EC-013 | Safe-state descent sequence undefined for active hazardous processes during governance failure — requirement live in Governance Failure Modes (EC-004, ratified). Three per-process implementations filed 2026-09-20: `Operations/Plastics.md`, `Operations/Air_Scrubber.md`, and `Operations/Gate_05_Separation_Thermal.md` §EC-013 Descent Sequences registered as Proposed/Placeholder (Path A). Blocking for hot runs retained. Remaining candidate files (Gate_03 conditional, Gate_06 partial) still lack registered sequences. Layer A interlocks remain distinct from Layer B descent. Tracker Status remains Open; no Payment-via-Specification on this entry until the agreed active set is complete. | `Admin/Ethical_Constraints.md` | Open | — | Major |
