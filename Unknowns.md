...
| FL-004 | Tooling inventory (ASM-003) has no owning file — checked `Architecture/Components.md` as candidate, it's a system taxonomy not a tool list and doesn't claim this ownership. Blocks full FL-001/Gate B determinism. Drafted fix (`Operations/Tooling_Inventory.md` skeleton) logged as HP-007, not yet created | `Architecture/Forge_flow.md` | Open | — | Major |
