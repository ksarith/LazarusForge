...
**Version 4.27 — 2026-07-25. Registration lag corrected — AP-024 and AP-029 were both genuinely Open in `Admin/Auditor_Protocols.md`'s own sidecar but missing from this index's AP- cluster, which had stopped at AP-019. AP-024 (human attestation provenance — "human-directed" collapses at least five distinguishable review levels into one label) has been Open since 2026-07-17; AP-029 (10-Entry Rule tripped, 14 open against a 10 threshold, unaddressed) since 2026-07-23. Same registration-lag class already named at v4.14 for this exact AP- cluster ("reverse-direction sibling of the RIP-008 registration-lag class") — worth noting this is now a repeat instance of a pattern this file has caught in itself twice.**
...
*Versions 4.16–4.23 (compressed; full text in `Unknowns_Changelog.md`):*
- **v4.23** (2026-07-17): GOV-014 through GOV-020 registered in `Admin/Governance_Charter.md` from a ChatGPT adversarial pass, verified against source before registration. All seven added alongside GOV-013, itself missing since creation three turns prior. Open Unknowns count in `Admin/Governance_Charter.md`: 12 → 19.
...
| AP-029 | 10-Entry Rule tripped by the sidecar's own open-count (14 open, threshold is 10), unaddressed | `Admin/Auditor_Protocols.md` | Open | — | Minor |
