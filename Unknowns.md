...
| FL-007 | Gate D/Oversight authority boundary unstated. **Update 2026-09-10:** confirmed to propagate across `Gate_03_Reduction.md` (two separate Reduction-entry conditions) and touch `Ethical_Constraints.md`'s High-Risk/VERIFIED authorization requirement — not purely internal. Risk raised Low→Medium, Priority Minor→Major | `Architecture/Forge_flow.md` | Open | — | Major |
