...
**Version 4.94 — 2026-09-03. Size Management Rule 2 violation fixed — "Pending Corrections" cluster (PC-001–006, six entries) was sitting in the Active Index with Status: Resolved, several with full descriptions, in violation of the rule immediately below. All six removed; detail preserved in `Archive/Logs/Unknowns_Changelog.md` (v4.94) since none had a single owning file. Found by Claude source-verifying a same-day Grok audit (human-directed). Full account in the changelog.**
