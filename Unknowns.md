...
| RIP-012 | No detection mechanism exists for a silent, no-side-effect Resolution Log deletion — confirmed via the RIP-010 drill itself | `Admin/Repository_Integrity_Protocol.md` | Open | — | Minor |
