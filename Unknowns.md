...
| ID | Title | Owning File | Status | Subtype | Priority (Promo) |
|---|---|---|---|---|---|
| EC-003 | **Ratified — Payment via Specification, 2026-08-22.** Human Escalation Protocol behavioral rules defined in full under `Admin/Ethical_Constraints.md` §Human Escalation Protocol. Channel implementation remains routed to Leviathan. Residuals EC-003-R1/R2 open non-blocking. | `Admin/Ethical_Constraints.md` | Resolved | — | Critical |
| EC-004 | **Ratified — Payment via Specification, 2026-08-22.** Governance Failure Modes Lifecycle defined in full under `Admin/Ethical_Constraints.md` §Governance Failure Modes. Removes last listed blocker on EC-007. Residuals EC-004-R1–R4 open non-blocking. | `Admin/Ethical_Constraints.md` | Resolved | — | Major |
| EC-005 | **Ratified — Payment via Specification, 2026-08-22.** Existing Anti-Weaponization clause "Humanitarian framing does not override this doctrine" is the priority rule; no new prose required. | `Admin/Ethical_Constraints.md` | Resolved | — | Critical |
| EC-006 | Ethical log survival under unit loss | `Admin/Ethical_Constraints.md` | Open | — | Non-blocking |
| EC-007 | Governance fail-safe | `Admin/Ethical_Constraints.md` | **Ratified — Payment via Specification, 2026-08-22.** | — | Blocking |
| EC-008 | **Ratified — Payment via Specification, 2026-08-22.** Inferred Authorization Annex defined under `Admin/Ethical_Constraints.md` §Core Mandate. Hard rule: inference never authorizes material alteration. Residuals EC-008-R1–R3 open non-blocking. | `Admin/Ethical_Constraints.md` | Resolved | — | Major |
| EC-009 | **Ratified — Payment via Specification, 2026-08-22.** Human Authority Conflict Doctrine defined under `Admin/Ethical_Constraints.md` §Human Escalation Protocol. Residuals EC-009-R1/R2 open non-blocking; GOV-019 remains owner of full authenticated-override priority table. | `Admin/Ethical_Constraints.md` | Resolved | — | Major |
...
| EC-016 | **Ratified — Payment via Specification, 2026-08-22.** Pending Ownership Declaration Convention integrated into `Admin/Governance_Charter.md` §Governance Authority Hierarchy. Residual EC-016-R1 open non-blocking. | `Admin/Ethical_Constraints.md` | Resolved | — | Minor |
...
| GOV-003 | **Resolved — Payment via Specification, ratified 2026-08-23.** Integrity enforcement architecture now defined in full: `Admin/Governance_Charter.md` §Integrity Enforcement Architecture — applies the existing Declared/Detectable/Reviewable/Enforceable ladder without redefining it, scopes the external-anchor requirement to constitutional integrity enforcement under compromise, and maps ownership across RIP/SEC/EC. Full Closure Event (Proposer: Grok; Skeptic/Verifier: ChatGPT, Conditional Pass then Accept pending SEC-002 source-verification — confirmed accurate; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-003 sidecar entry. Four residuals (GOV-003-R1 through R4) remain open as non-blocking child notes — GOV-003-R1 (SEC-007b instantiation) is the primary blocker for constitutional Enforceability under compromise | `Admin/Governance_Charter.md` | Resolved | — | Critical |
...
| GOV-014 | **Resolved — Payment via Specification, ratified 2026-08-20.** Governance complexity ceiling now defined in full: `Admin/Governance_Charter.md` §Governance Complexity Ceiling. Full Closure Event (Proposer: Grok; Verifier: ChatGPT, Pass; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-014 sidecar entry. Three residuals (GOV-014-R1 through R3) remain open as non-blocking child notes | `Admin/Governance_Charter.md` | Resolved | — | Major |
| GOV-015 | **Resolved — Payment via Specification, ratified 2026-08-23.** Constitutional interpretation capture (aggregate reinterpretation via subordinate doctrine volume, distinct from single-file case GMP-005 covers) now defined in full: `Admin/Governance_Charter.md` §Constitutional Interpretation Capture — Aggregate Drift Detection. Full Closure Event (Proposer: Grok; Skeptic/Verifier: ChatGPT, two-pass — Revise then Accept; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-015 sidecar entry. Three residuals (GOV-015-R1 through R3) remain open as non-blocking child notes | `Admin/Governance_Charter.md` | Resolved | — | Critical |
| GOV-016 | **Resolved — Payment via Specification, ratified 2026-08-20.** Governance pruning doctrine now defined in full: `Admin/Governance_Charter.md` §Governance Pruning Doctrine. Full Closure Event (Proposer: Grok; Verifier: ChatGPT, Pass — assessed as strongest of the three; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-016 sidecar entry. Three residuals (GOV-016-R1 through R3) remain open as non-blocking child notes | `Admin/Governance_Charter.md` | Resolved | — | Minor |
...
| GOV-018 | **Resolved — Payment via Specification, ratified 2026-08-23.** Governance fork reconciliation now defined in full: `Admin/Governance_Charter.md` §Governance Fork Reconciliation (constitutional principles) and `Admin/Governance_Migration_Protocol.md` §Fork Reconciliation Track (operative procedure). Full Closure Event (Proposer: Grok; Skeptic/Verifier: ChatGPT, three-pass — Revise, Revise, Accept; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-018 sidecar entry. Three residuals (GOV-018-R1 through R3) remain open as non-blocking child notes | `Admin/Governance_Charter.md` | Resolved | — | Critical |
| GOV-019 | Conflicting authenticated human override arbitration undefined | `Admin/Governance_Charter.md` | Open | — | Major |
| GOV-020 | **Resolved — Payment via Specification, ratified 2026-08-20.** Governance cost metric now defined in full: `Admin/Governance_Charter.md` §Governance Cost Metric. Full Closure Event (Proposer: Grok; Verifier: ChatGPT, Pass contingent on an arithmetic correction, then applied; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-020 sidecar entry. Four residuals (GOV-020-R1 through R4) remain open as non-blocking child notes | `Admin/Governance_Charter.md` | Resolved | — | Minor |
...
| GOV-022 | **Resolved — Payment via Specification, ratified 2026-08-21.** Reversibility now named as a cross-cutting Operating Principle: `Admin/Governance_Charter.md` §Operating Principles / Reversibility, connecting Gate_03_Reduction.md, the Discharge Procedure, and the Epistemic Ledger — three independent implementations of the same principle, previously with zero cross-linking to each other or to Axiom P-1/Q-3. Full Closure Event (Proposer: Claude; Verifier: ChatGPT, Pass — reversed its own initial Option (c) preference after source investigation; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Governance_Charter_Changelog.md`'s GOV-022 sidecar entry | `Admin/Governance_Charter.md` | Resolved | — | Minor |
| SEC-001 | Quorum recovery under terminal partition | `Admin/Security_Protocols.md` | Open | — | Major |
| SEC-002 | Key revocation doctrine undefined | `Admin/Security_Protocols.md` | **Ratified — Payment via Specification, 2026-08-22.** | — | Major |
...
| SEC-007a | External root-of-trust — constitutional requirements for the anchor (owning layer: Admin) — vertically split from SEC-007 2026-07-02 — Design Lineage: PAT-001 | `Admin/Security_Protocols.md` | **Ratified — Payment via Specification, 2026-08-22.** | — | Critical |
...
| SEC-009 | Compromise detection criteria undefined — blocks revocation trigger definition | `Admin/Security_Protocols.md` | **Ratified — Payment via Specification, 2026-08-22.** | — | Major |
...
| AP-004 | **Resolved — Payment via Specification, ratified 2026-08-20.** Cross-auditor disagreement resolution now defined in full: `Admin/Auditor_Protocols.md` §Dispute Handling Protocol, three-tier path. Full Closure Event (Proposer: Grok, with a self-produced Revision 1; Verifier: ChatGPT, Pass — Grok's second consecutive correct self-verification refusal; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Auditor_Protocols_Logs.md`'s AP-004 sidecar entry. Four residuals (AP-004-R1 through R4) remain open as non-blocking child notes | `Admin/Auditor_Protocols.md` | Resolved | — | Major |
...
| AP-013 | **Resolved — Payment via Specification, ratified 2026-08-19.** Unknown closure authority now defined in full: `Admin/Auditor_Protocols.md` §Unknown Closure Authority. Full Closure Event (Proposer: Claude; Verifier: Grok, Conditional Pass; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Auditor_Protocols_Logs.md`'s AP-013 sidecar entry — see there for complete provenance. Four residuals (AP-013-R1 through R4) remain open as non-blocking child notes, not tracked separately here | `Admin/Auditor_Protocols.md` | Resolved | — | Major |
...
| AP-024 | **Resolved — Payment via Specification, ratified 2026-08-20.** Human attestation provenance now defined in full: `Admin/Auditor_Protocols.md` §Human Attestation Provenance Protocol. Full Closure Event (Proposer: ChatGPT; pre-integration Reviewer: Grok; Verifier: Copilot, genuinely independent; Human Ratification: Human Governing Authority) recorded in `Archive/Logs/Auditor_Protocols_Logs.md`'s AP-024 sidecar entry. A fabricated Gemini review (inventing an unrelated "H0–H5" scale) was identified and excluded from the ratification basis. Five residuals (AP-024-R1 through R5) remain open as non-blocking child notes | `Admin/Auditor_Protocols.md` | Resolved | — | Major |
...
| WA-002 | **Resolved — Payment via Specification, ratified 2026-08-23.** Hazardous fraction identification reliability now fully specified: `Challenges/Waste.md` §Hazardous Fraction Identification Protocol — asbestos presumption-and-isolate, heavy-metal component/provenance presumption, BFR via shared PL-001 Beilstein screen (Cl/Br class only), plus operator training/demonstration standard (T1–T6) and confirmatory lab-arrangement structure with an explicit lab-result-is-not-authorization rule. Full Closure Event (Proposer: Grok; Skeptic/Verifier: ChatGPT, one revision then Accept; Human Ratification: Human Governing Authority) recorded in `Challenges/Waste.md`'s own Resolution Log. Three residuals (WA-002-R1 through R3) remain open as non-blocking child notes — WA-002-R1 (feedstock validation) keeps this unknown functionally blocking for operational reliance despite specification closure, same pattern as PL-001 | `Challenges/Waste.md` | Resolved | — | Critical |
...
| ID | Title | Owning File | Status | Subtype | Priority (Promo) |
|---|---|---|---|---|---|
| PL-001 | **Resolved — Payment via Specification, ratified 2026-08-23.** Halogenated polymer contamination (HCl/dioxin release from PVC/Teflon) triage protocol now defined in full: `Operations/Plastics.md` §PL-001 — class-split screening (PVC/Cl-Br via Beilstein+density; PTFE/fluoropolymer via labeling+density band, since Beilstein does not reliably detect fluorine). Full Closure Event (Proposer: Grok; Skeptic/Verifier: Claude, one revision then Accept; Human Ratification: Human Governing Authority) recorded in `Operations/Plastics.md`'s own Resolution Log. Four residuals (PL-001-R1 through R4) remain open as non-blocking child notes — PL-001-R1 (empirical validation against representative feedstock) keeps this unknown's Blocking Yes in force for any hot operational run; specification closure and operational clearance are deliberately distinct | `Operations/Plastics.md` | Resolved | — | Critical |
