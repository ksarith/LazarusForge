...
**Last updated: 2026-09-18 — Two new files registered: `Operations/Exception_Evidence.md` (created as the evidence-control specification and index for Oversight State's exception evidence portfolio — FL-006 half A structural owner; not a warehouse) and `Tests/Multi_Agent_Quorum_Trial.md` (the concrete three-physical-computer quorum trial protocol that `CONTRIBUTING.md` and `Tests/Field_Logs.md` now point to; operationalizes `Admin/Governance_Migration_Protocol.md` §VII without amending it).**
**Prior: 2026-09-15**
