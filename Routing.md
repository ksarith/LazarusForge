...
| `Admin/PROBE_INVOCATION.md` | https://raw.githubusercontent.com/ksarith/LazarusForgeV0/refs/heads/main/Admin/PROBE_INVOCATION.md | https://github.com/ksarith/LazarusForgeV0/blob/main/Admin/PROBE_INVOCATION.md | Explicit |
...
| `Admin/Nothingness_Theorem.md` | https://raw.githubusercontent.com/ksarith/LazarusForgeV0/refs/heads/main/Admin/Nothingness_Theorem.md | https://github.com/ksarith/LazarusForgeV0/blob/main/Admin/Nothingness_Theorem.md | Explicit |
| `Admin/CIR_Gov.md` | https://raw.githubusercontent.com/ksarith/LazarusForgeV0/refs/heads/main/Admin/CIR_Gov.md | https://github.com/ksarith/LazarusForgeV0/blob/main/Admin/CIR_Gov.md | Explicit |
| `Admin/Computational_Institutional_Reasoning.md` | https://raw.githubusercontent.com/ksarith/LazarusForgeV0/refs/heads/main/Admin/Computational_Institutional_Reasoning.md | https://github.com/ksarith/LazarusForgeV0/blob/main/Admin/Computational_Institutional_Reasoning.md | Explicit |
...
**Note on Admin/Nothingness_Theorem.md and Admin/Computational_Institutional_Reasoning.md:** Renamed 2026-07-31 (from `Admin/Nothingness Theorem` and `Admin/Computational Institutional Reasoning`, both previously filed without a `.md` extension and containing spaces, URL-encoded as %20 in raw/repo links) to standard `.md`, underscore-separated filenames for workflow consistency. Both files now resolve through the dynamic `_parse_routing()` registry builder like any other file; the hardcoded `ALIASES` entries in `Automation/AUDIT_HARNESS.py` that previously handled their non-standard names have been updated to the new paths, not removed, since other tooling may still reference the alias keys by their old display names. Nothingness Theorem is a philosophical substrate document (Admin/, intentionally functionless per its own doctrine); it carries a minimal Tier 0 File State sidecar sufficient for Phase 1 Ethical Anchor verification but is exempt from operational promotion gates. Computational Institutional Reasoning is the formal theoretical paper containing the axioms, theorems, and Verification Algebra that back CF-004, AP-006, and related epistemic-debt doctrine in Unknowns.md and Auditor_Protocols.md; it carries a full standard File State sidecar as of v0.16 (2026-06-30) and is subject to standard promotion gate tracking. Historical Archive/Logs/ changelog entries predating 2026-07-31 retain the old names — those entries are accurate descriptions of repository state at the time they were written and were deliberately not retroactively renamed.

**Note on Admin/CIR_Gov.md:** New file, 2026-07-31. A candidate epistemic governance kernel (predicate-gated state transitions, typed unknowns with debt accounting, provenance ceilings) drafted as CIR v2.0, filed in full to preserve the architecture intact. Filed **Proposed — Not Ratified**: its central "agent-independent state transitions" claim structurally depends on GOV-008 (minimum agent/hardware quorum, owned by `Admin/Governance_Charter.md`), which remains Open with no concrete specification. Adopting or citing this file as operational governance before GOV-008 is ratified would misrepresent the repository's actual Q-2 (Separation of Powers) status — see the file's own Binding Status section. Does not merge with or amend `Governance_Charter.md`; relationship is documented in the file's own Relationship section.
